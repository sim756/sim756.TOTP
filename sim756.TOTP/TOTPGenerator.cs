...
namespace sim756.TOTP
{
    public class TOTPGenerator
    {
        ...
        public TOTPGenerator(byte[] key, int hotpLength = DefaultLength, int hotpStep = DefaultSteps)
        {
            Key = key;
            Length = hotpLength;
            Steps = hotpStep;
        ...
        public TOTPGenerator(string key, int hotpLength = DefaultLength, int hotpStep = DefaultSteps)
        {
